...
OUT=BASE/'curobo-shape-adaptive-final-task002-20260913';OUT.mkdir(exist_ok=True)
...
report={}
variants=[('ref','#ef8b23',next(COL.glob('236*-ref.traj'))),('curobo','#00a6c8',next(COL.glob('236*-curobo.traj'))),('adaptive','#398c48',BASE/'curobo-shape-adaptive-local-task002-20260913/adaptive-local-0.7.traj')]
